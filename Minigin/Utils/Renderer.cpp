...
void dae::Renderer::RenderTexture(const Texture2DDisplay &texture, const float x, const float y) const {
    SDL_FRect dst{};
    dst.x = x;
    dst.y = y;
...
void dae::Renderer::RenderTexture(
    const Texture2DDisplay &texture, const float x, const float y, const float width, const float height) const {
    SDL_FRect dst{};
    dst.x = x;
    dst.y = y;
    dst.w = width;
